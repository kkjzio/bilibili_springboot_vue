...
CREATE TABLE `favourite` (
  ...
  `videoImage` varchar(160) DEFAULT NULL,
...
insert  into `favourite`(`favouriteID`,`videoID`,`videoName`,`videoImage`,`userID`,`favouriteTime`) values (14,'8','【AMV】 战斗意志不灭 ！！！','/static/videolook/videolookimg/9325861-1-hd.png','004bcfc8d4bd407bb1a114785539006f','2022-09-26 19:41:08'),(21,'11','【炮姐/AMV】我永远都会守护在你的身边！','/static/videolook/videolookimg/1176840-1-hd.png','004bcfc8d4bd407bb1a114785539006f','2022-09-27 09:31:35'),(22,'26','【ASMV综漫燃向】为了什么而战，为了变强，能保护你那么强','/static/videolook/videolookimg/weilebianqiang.png','004bcfc8d4bd407bb1a114785539006f','2022-09-27 09:31:47'),(24,'52','Y2Mate.is - Cyberpunk Edgerunners','/static/videolook/videolookimg/1664525437383.jpg','004bcfc8d4bd407bb1a114785539006f','2022-09-30 16:13:38'),(25,'49','【中字PV_SC】#P对自家偶像的评价也太不得了了吧——闪耀色彩3.5周年纪念视频','/static/videolook/videolookimg/1663298210940.jpg','004bcfc8d4bd407bb1a114785539006f','2022-10-26 10:57:27');
...
CREATE TABLE `message` (
  ...
  `messageHand` varchar(100) NOT NULL,
  PRIMARY KEY (`messageID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `message` */

insert  into `message`(`messageID`,`messagevideoID`,`messageuserID`,`messageuserName`,`messageTime`,`message`,`messageHand`) values ('01f4fff6b56846329a6483917dc30eff','49','283405a2f5f4468184b6e9eab0e33a90','kkjz3','2022-10-04 14:46:59','https://www.youtube.com/watch?v=yoGBXRpUwvw','/static/userHand_Top/upload/MyHand.png'),('2d7229ff55514daa9c1e25634e93099c','49','004bcfc8d4bd407bb1a114785539006f','admin','2022-10-04 21:49:53','233333','/static/userHand_Top/upload/1665130709485.jpg'),('2f57b96d2e4f4e29bbc606d9cae327a5','49','283405a2f5f4468184b6e9eab0e33a90','kkjz3','2022-10-04 14:45:23','testtt','/static/userHand_Top/upload/MyHand.png'),('4b3b930c0f7046648ed4329728fa4e21','49','283405a2f5f4468184b6e9eab0e33a90','kkjz3','2022-10-04 14:46:40','当初见到这个原版PV的时候真的被SC震撼到了','/static/userHand_Top/upload/MyHand.png'),('4dd6800f84994633866553249c7c6ca7','49','004bcfc8d4bd407bb1a114785539006f','admin','2022-10-04 21:49:50','test','/static/userHand_Top/upload/1665130709485.jpg'),('5c053ff67a5f4b799ef538c07e925eac','10','004bcfc8d4bd407bb1a114785539006f','admin','2022-10-04 21:43:53','123','/static/userHand_Top/upload/1665130709485.jpg'),('63b024e9cdd44a268e10dba2bef02075','52','004bcfc8d4bd407bb1a114785539006f','admin','2022-10-03 21:49:53','子弹杯里伏特加加小可乐，生的伟大 死的光荣','/static/userHand_Top/upload/1665130709485.jpg'),('6b644fb2a20c4c95b6d983c8f174197c','49','004bcfc8d4bd407bb1a114785539006f','admin','2022-10-04 14:47:53','水平有限，有错误或不适的地方欢迎大力指正','/static/userHand_Top/upload/1665130709485.jpg'),('bb7cab4a77534fc6b1dd301b156e4ea3','49','283405a2f5f4468184b6e9eab0e33a90','kkjz3','2022-10-04 14:46:53','也非常欢迎大家用这个视频去安利那些想要入坑sc的朋友。','/static/userHand_Top/upload/MyHand.png'),('e976f0de8da34f15969f1933134e03d0','49','283405a2f5f4468184b6e9eab0e33a90','kkjz3','2022-10-04 14:46:47','如果你也能从这个视频了收获到些许的快乐甚至于成为你了解SC的契机那我将非常荣幸','/static/userHand_Top/upload/MyHand.png');
...
CREATE TABLE `user` (
  ...
  `userHand` varchar(160) DEFAULT NULL,
